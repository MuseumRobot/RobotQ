...
AccountInfo::AccountInfo()
{
	...
	string path_prefix = ".";		//工程目录前缀
	//string path_prefix = "D:\\RobotQ\\RobotQ";	//都是被逼无奈绝对路径试一下（好用）
#ifdef _WIN32_WCE
	path_prefix = "/SDMMC";
#endif

	test_data_path_ = path_prefix + "\\testdata";
	data_path_ = path_prefix + "\\testdata";
	auth_path_ = path_prefix + "\\testdata";
	logfile_path_ = path_prefix + "\\testdata";
}
